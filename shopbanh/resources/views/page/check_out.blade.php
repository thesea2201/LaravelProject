			...
			<div class="row">
				...
				<div class="col-sm-6">
					...
					<div class="form-block">
						...
						<textarea id="notes" name="notes" placeholder="Ghi chú cho người bán" required></textarea>
					</div>
				</div>
				<div class="col-sm-6">
						...
						<div class="your-order-body" style="padding: 0px 10px">
									...
									<!--  one item	 -->
										<div class="media">
											...
											<div class="media-body">
												...
												<span class="color-gray your-order-info">Price: {{ $product['price'] }}</span>
							...
							<div class="your-order-item">
								...
								<div class="pull-right"><h5 class="color-black">
									@if (Session::has('cart'))
										{{ number_format($cart->totalPrice) }}đ
									@else
										0đ
									@endif</h5></div>
								<div class="clearfix"></div>
